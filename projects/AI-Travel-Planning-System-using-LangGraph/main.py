...
import psycopg
from psycopg.rows import dict_row  # Required for LangGraph dictionary mappings
...
# FIX: Added autocommit=True and row_factory=dict_row to support LangGraph migrations
